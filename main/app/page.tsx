  ...
  useEffect(() => {
    ...
    <div className="bg-gray-900 min-h-screen text-white p-8 flex flex-col items-center justify-center">
      ...
      <div className="flex flex-row space-x-10">
        ...
        <Link 
          href="/token-metrics" 
          className="bg-green-500 hover:bg-green-700 text-white font-bold py-4 px-6 rounded text-center flex flex-col items-center"
        >
          {tokenData ? (
          <svg className="w-32 h-32 m-4" viewBox="0 0 232.068 232.068" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link 
          href="/exchange-data" 
          className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-4 px-6 rounded text-center flex flex-col items-center"
        >
          {broadExchangeData ? (
